...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
    	...
    	<img src="web.png" width="30" height="30" class="d-inline-block align-top" alt=""> College Match
  		</a>
  <!-- Links -->
	...
	<div class="background">
		<i class="fa fa-quote-left"></i><p>Hard work meets opportunity. University, let’s dance</p>
	</div>
	<div class="background">
